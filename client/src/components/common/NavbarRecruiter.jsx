    ...
    <header className="sticky top-0 z-50 bg-white border-b border-slate-200 shadow-sm">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-10">
        ...
        <nav className="hidden items-center gap-8 md:flex text-sm font-medium text-slate-700">
          <AnimatedLink to="/recruiter/dashboard">Dashboard</AnimatedLink>
          <AnimatedLink to="/recruiter/company">My Company</AnimatedLink>
          <AnimatedLink to="/recruiter/jobs">Job Postings</AnimatedLink>
          <AnimatedLink to="/recruiter/applications">Applications</AnimatedLink>
          <AnimatedLink to="/recruiter/features">Company Features</AnimatedLink>
        </nav>
