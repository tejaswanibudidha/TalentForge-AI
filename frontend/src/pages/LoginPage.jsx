  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4 py-12">
      <div className="w-full max-w-md rounded-3xl bg-white p-8 shadow-lg shadow-slate-200">
        <h2 className="text-2xl font-semibold text-slate-900">Sign in to TalentForge AI</h2>
        <p className="mt-2 text-slate-500">Resume analysis, ATS scoring and smart matching in one dashboard.</p>
        <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
          ...
          <button className="w-full rounded-2xl bg-brand-800 px-5 py-3 text-white transition hover:bg-brand-700">Continue</button>
        </form>
        <p className="mt-6 text-center text-sm text-slate-500">Don&apos;t have an account? <a href="/register" className="text-brand-800 font-semibold">Create one</a></p>
      </div>
    </div>
  );
}
